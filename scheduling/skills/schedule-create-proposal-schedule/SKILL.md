...
The standard naming convention is **Verb + Noun** with **allowed industry acronyms** and **& in place of "and"**. All activity names generated by this skill must follow this pattern.

**Allowed acronyms:** HVAC, MEP, CMU, GC, SWPPP, OAC, RFI, IFC, TAB. Use these freely — they are standard construction shorthand that every scheduler and field team recognizes.

**Always spell out:** Notice to Proceed, Substantial Completion, Final Completion (these are contract-defined terms — never abbreviate to NTP, SC, or FC).

**Use & instead of "and":** e.g., "Tape & Finish Drywall", "Test & Balance HVAC", "Curb, Gutter & Sidewalks".

The question below is about modifiers — area suffixes, floor prefixes — not whether to use verb-noun or acronyms.

```
Context to pull: From sample XERs — extract 10-15 representative activity names from
each schedule. Identify naming patterns and modifier conventions.

Present: "The standard for activity naming is Verb + Noun with allowed acronyms & shorthand:
  - Tie Rebar
  - Pour Concrete
...
Allowed acronyms: HVAC, MEP, CMU, GC, SWPPP, OAC, RFI, IFC, TAB.
Always spell out: Substantial Completion, Final Completion.

The sample schedules used:
Schedule A: [show examples]
...
**All activity names must follow Verb + Noun convention** with allowed industry acronyms
(HVAC, MEP, CMU, GC, SWPPP, OAC, RFI, IFC, TAB) and & in place of "and"
(e.g., Rough In HVAC Ductwork, Install MEP Systems, Tape & Finish Drywall).
...
**Naming Convention:** Verb + Noun with allowed acronyms (HVAC, MEP, CMU, GC, SWPPP, OAC, RFI, IFC, TAB) & shorthand (e.g., Rough In HVAC Ductwork, Tape & Finish Drywall). Always spell out Notice to Proceed, Substantial Completion & Final Completion. [Modifier preferences from Q12: area suffix, floor prefix]
...
will follow the Verb + Noun naming convention with allowed acronyms
(HVAC, MEP, CMU, GC, SWPPP, OAC, RFI, IFC, TAB) and & shorthand
(e.g., Rough In HVAC Ductwork, Tape & Finish Drywall). All durations in
...
3. Ensure all generated activity names follow Verb + Noun convention with allowed acronyms (HVAC, MEP, CMU, GC, SWPPP, OAC, RFI, IFC, TAB) and & shorthand
